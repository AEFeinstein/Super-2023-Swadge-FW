...
bool readNamespacedNvsU8(const char* namespace, const char* key, uint8_t* outVal)
{
    ...
    switch(openErr)
    {
        case ESP_OK:
        {
            ...
            bool readOk = false;
            // Write the NVS
            esp_err_t readErr = nvs_get_u8(handle, key, outVal);
...
bool writeNamespacedNvsU8(const char* namespace, const char* key, uint8_t val)
{
    ...
    switch(openErr)
    {
        case ESP_OK:
        {
            ...
            bool commitOk = false;
            // Write the NVS
            esp_err_t writeErr = nvs_set_u8(handle, key, val);
            // Check the write error
            switch(writeErr)
            {
                case ESP_OK:
...
bool readNamespacedNvsU32(const char* namespace, const char* key, uint32_t* outVal)
{
    ...
    switch(openErr)
    {
        case ESP_OK:
        {
            ...
            bool readOk = false;
            // Write the NVS
            esp_err_t readErr = nvs_get_u32(handle, key, outVal);
            // Check the write error
            switch(readErr)
            {
                case ESP_OK:
...
bool writeNamespacedNvsU32(const char* namespace, const char* key, uint32_t val)
{
    ...
    switch(openErr)
    {
        case ESP_OK:
        {
            ...
            bool commitOk = false;
            // Write the NVS
            esp_err_t writeErr = nvs_set_u32(handle, key, val);
            // Check the write error
            switch(writeErr)
            {
                case ESP_OK:
