...
static const char* creditNames[] =
{
    ...
    "our homes with power washers and M-80s! One-eighth a stick of dynamite!\n",
    ...
    "our studio, discussing their new book, classy Ladies, out this week on Hexagon.\n",
    ...
    "Bees have good qualities. And it takes my mind off the shop. Instead of flowers,\n", 
    ...
    "waits, because for the first time in history, we will hear for ourselves\n", 
