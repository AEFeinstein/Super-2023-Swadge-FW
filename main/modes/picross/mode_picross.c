...
// Function Prototypes
//==============================================================================
void picrossPlayerInput(void);
void picrossRemoveEnemies(void);
void picrossResetPlayer(void);
void picrossCheckLevel(void);
void picrossKillPlayer(void);
void picrossDoEvilDonut(int64_t elapsedUs);
void picrossDoBlump(int64_t elapsedUs);
void picrossSetupState(uint8_t stageIndex);
...
{
    j = calloc(1, sizeof(picrossGame_t));
...
void picrossGameLoop(int64_t elapsedUs)
{
    ...
    switch(j->currentPhase)
    {
        ...
        case JUMPER_GAMING:
            ...
            {
                picrossDoEvilDonut(elapsedUs);
                picrossDoBlump(elapsedUs);
            }
            break;
...
void drawPicrossScene(display_t* d)
{
    ...
    drawPicrossHud(d, j->promptFont, &j->game_font);
