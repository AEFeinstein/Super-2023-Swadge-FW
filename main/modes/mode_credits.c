...
const song_t creditsSong =
{
    .notes =
    {
        ...
        {.note = A_3, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = C_SHARP_4, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = F_SHARP_4, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = B_4, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = C_SHARP_5, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = F_SHARP_5, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = A_3, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = C_SHARP_4, .timeMs = 87},
        ...
        {.note = E_5, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
        {.note = F_SHARP_5, .timeMs = 468},
        {.note = G_7, .timeMs = 29},
        {.note = F_SHARP_7, .timeMs = 29},
        {.note = F_7, .timeMs = 29},
        {.note = E_7, .timeMs = 29},
        {.note = D_SHARP_7, .timeMs = 29},
        {.note = D_7, .timeMs = 29},
        {.note = C_SHARP_7, .timeMs = 29},
        {.note = C_7, .timeMs = 29},
        {.note = B_6, .timeMs = 29},
        {.note = A_SHARP_6, .timeMs = 29},
        {.note = A_6, .timeMs = 29},
        {.note = G_SHARP_6, .timeMs = 29},
        {.note = G_6, .timeMs = 29},
        {.note = F_SHARP_6, .timeMs = 29},
        {.note = F_6, .timeMs = 29},
        {.note = E_6, .timeMs = 29},
        {.note = B_3, .timeMs = 87},
        {.note = SILENCE, .timeMs = 29},
