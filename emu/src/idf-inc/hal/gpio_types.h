...
#define GPIO_SEL_24             (BIT(24))                        /*!< Pin 23 selected */
...
#define GPIO_MODE_DEF_INPUT           (0x01)    ///< bit mask for input
#define GPIO_MODE_DEF_OUTPUT          (0x02)    ///< bit mask for output
#define GPIO_MODE_DEF_OD              (0x04)    ///< bit mask for OD mode
/** @endcond */
